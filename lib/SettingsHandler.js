...
SettingsHandler.prototype.getSettings = function() {
    ...
    settings.load = function() {
        ...
        try {
            ...
            console.log("Failed to get lock whilst loading settings! Lock file located at: " + settingsFilePath + ".lock");
            console.log(e);
            process.exit(1)
            return;
        }
        ...
        try {
            ...
            console.log("Failed to remove lock whilst loading settings! Lock file located at: " + settingsFilePath + ".lock");
            console.log(e);
            process.exit(1)
        }

    ...
    callback(
        [
            0, [
                ...
                "\t",
                colors.bold("\tSettings:") + colors.grey(" Settings are also saved to file (not in HANA)"),
                ...
                "\tcut " + colors.grey("{AMOUNT_OF_CHARS}") + "\t\t\t- Cut off characters from one side of the file.",

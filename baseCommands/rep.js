...
ReplicationCommandHandler.prototype.run = function(command, cParts, conn, screen, callback){
	...
	var query = '' +
        'SELECT ' +
        	...
        	// '"M_VOLUMES"."SERVICE_NAME", "M_VOLUMES"."SUBPATH", ' +
            '"M_SERVICE_REPLICATION"."VOLUME_ID", ' +
            // '"M_SERVICE_REPLICATION"."SITE_NAME", ' +
            '"M_SERVICE_REPLICATION"."SECONDARY_HOST", ' +
            // '"M_SERVICE_REPLICATION"."SECONDARY_SITE_NAME", ' +
            '"M_SERVICE_REPLICATION"."REPLICATION_STATUS", ' +
            // '"M_SERVICE_REPLICATION"."REPLICATION_MODE", ' +
            // 'SECONDS_BETWEEN(\'1970-01-01 00:00:00\', "M_SERVICE_REPLICATION"."LAST_LOG_POSITION_TIME"), ' +
            // 'SECONDS_BETWEEN(\'1970-01-01 00:00:00\', "M_SERVICE_REPLICATION"."SHIPPED_LOG_POSITION_TIME"), ' +
            '"M_SERVICE_REPLICATION"."LAST_LOG_POSITION_TIME", ' +
            '"M_SERVICE_REPLICATION"."SHIPPED_LOG_POSITION_TIME", ' +

...
ParitionsCommandHandler.prototype.run = function(command, cParts, conn, screen, callback){
	...
	conn.exec("conn", "SELECT T.PART_ID, T.LOADED, P.RANGE, T.RECORD_COUNT, CAST(T.MEMORY_SIZE_IN_TOTAL / 1024 / 1024 AS DECIMAL(10, 2)) AS SIZE_GB, CAST(T.ESTIMATED_MAX_MEMORY_SIZE_IN_TOTAL / 1024 / 1024 AS DECIMAL(10, 2)) AS MAX_SIZE_GB \

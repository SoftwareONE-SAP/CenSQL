...
WorkloadCommandHandler.prototype.run = function(command, cParts, conn, screen, callback){
	...
	conn.exec("conn", "SELECT HOST, PORT, CURRENT_EXECUTION_RATE, CURRENT_COMPILATION_RATE, CURRENT_UPDATE_TRANSACTION_RATE, CURRENT_TRANSACTION_RATE, CURRENT_COMMIT_RATE, CURRENT_ROLLBACK_RATE FROM M_WORKLOAD", function(err, data) {

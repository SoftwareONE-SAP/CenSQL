...
var CommandHandler = function(screen, hdb, settings) {
    this.screen = screen;
    this.hdb = hdb;
...
CommandHandler.prototype.loadCommandHandlers = function() {
    ...
    this.handlers["dbs"] = new(require("./baseCommands/dbs.js"))(this);
    ...
    this.handlers["tasklog"] = new(require("./baseCommands/tasklog.js"))(this);
    this.handlers["tasks"] = new(require("./baseCommands/tasks.js"))(this);
